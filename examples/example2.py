'''
Auto-generated by afw_media: plays back "example2.afwframes" using afw.

Usage:
    python3 example2.py

Requires the project root to be on PYTHONPATH, or run from the repo root..
...
def main() -> None:
    asset_path = Path(__file__).resolve().parent / "example2.afwframes"
